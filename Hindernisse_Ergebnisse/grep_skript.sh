...
#done
grep -A 10000 "Für mehr Daten, bitte Gerät drehen." 20_Ergebnisse_Halbfinale_1.txt | tail -10000 | grep -B 10000 "Ninja Warrior Germany Mixed Ninja Warrior Germany Mixed" | head -10000 > 20_Ergebnisse_Halbfinale_1_short.txt
